...
SELECT GRADE,COUNT(*) FROM CUSTOMER2 GROUP BY GRADE HAVING GRADE>(SELECT AVG(GRADE) FROM CUSTOMER2); #q1
...
FROM ORDERS c
WHERE c.Ord_Date=b.Ord_Date);                  #a4

SELECT * FROM SALES;
INSERT INTO SALESMAN VALUES(1000,"ANJU","PUNJAB",'5');     #
SELECT * FROM SALESMAN;

DELETE FROM SALESMAN WHERE Sid='1000'; #q5
